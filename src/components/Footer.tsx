  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <p style={{ fontWeight: 700, fontSize: '1.1rem', marginBottom: 4 }}>Coral Fit</p>
        <p style={{ fontSize: '0.85rem', opacity: 0.85, marginBottom: 20 }}>
          Moda praia e fitness com estilo
        </p>
        ...
        <p style={{ fontSize: '0.75rem', opacity: 0.6 }}>
          © {new Date().getFullYear()} Coral Fit · Todos os direitos reservados
        </p>
      </div>
    </footer>
  );
